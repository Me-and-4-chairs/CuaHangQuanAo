...
function layThongTinSanPhamTuTable(id) {
    ...
    var chatlieu = tr[11].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var form = tr[12].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var size = tr[13].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var color = tr[14].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var tke = tr[15].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var dly = tr[16].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["Manchester United", "Manchester City", "Arsenal", "Juventus", "Liverpool"];
    ...
    s += `
        ...
        <tr>
            <td>Form:</td>
            <td><input type="text" value="`+ sp.detail.form + `"></td>
        </tr>
        <tr>
            <td>Size:</td>
        ...
        <tr>
            <td>Thiết kế:</td>
            <td><input type="text" value="`+ sp.detail.tke + `"></td>
        </tr>
        <tr>
            <td>Đại lý phân phối:</td>
            <td><input type="text" value="`+ sp.detail.dly + `"></td>
        </tr>
        <tr>
