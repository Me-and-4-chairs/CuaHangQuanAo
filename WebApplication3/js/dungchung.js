	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="trungtambaohanh.html"><i class="fa fa-wrench"></i> Chi Nhánh</a></li>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ Shop Bán Quần Áo Thể Thao" title="Shop Bán Quần Áo Thể Thao">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Shop Quần Áo Thể Thao</a> - Designed by
            <span style="color: #eee; font-weight: bold">Trường An</span></p>
    </div>`);
}
				...
				for (var li of li_s) {
					...
					switch (loai) {
						...
						case "Màu sắc:":
							...
							break;
						case "Thiết kế:":
							result.detail.tke = giatri;
							break;
						case "Đại lý ủy quyền:":
							result.detail.dly = giatri;
							break;			
					}
				}
